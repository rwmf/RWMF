            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">Ticket Info</h3>
                            ...
                            <div class="card-block">
                                ...
                                <div class="m-t-30">
                                    <?php
                                        ...
                                        {
                                            if(file_exists($ticket_data->location))
                                            {
                                                $ticket_location=base_url().$ticket_data->location.'?'.time();
                                            }
                                        }
                                        ...
                                        echo form_open_multipart(base_url('admin/ticketinfo'), array('name' => 'ticketinfo', 'id' => 'ticketinfo', 'class' => ' form-material')); ?>
                                                ...
                                                <div class="form-group ">
                                                    <label for="link" class="mr-3">Ticket Booking Link</label>
                                                    <input required type="url" name="link" placeholder="booking web url" class="form-control form-control-line" value="<?php echo set_value('link',$ticket_data->link); ?>">
    ...
    <div class="modal-dialog modal-confirm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="<?php echo base_url('ticketinfo/delete'); ?>"><button type="button" class="btn btn-danger">Delete</button></a>
            </div>
        </div>
    </div>
</div> 
